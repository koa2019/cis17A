...
void fillVec(vector<int>&,int,int,int);//int *fillAry(int,int,int);
int  **fillAry(int,int);
void fillAry(int **,vector<int> &,int,int);//void fillAry(int **,int *,int,int);
void destroy(int **,int);
void swap(int &,int &);
void smlLst(vector<int>&,int);//void smlLst(int [],int,int);
void mrkSort(vector<int>&);//void mrkSort(int [],int);
