...
////***************************************
//
//T * Prb2Sort::sortArray(const T *arr, int column, bool ascending){ 
//    
...
////***********************************************************
//
//T * Prb2Sort::sortArray(const char *ch2p, int rows, int cols, int column, bool ascending) {
//
//    //cout << "\n\nInside sort().\nsize = " << size << endl;
//    
//    //index = &column;  //set class variable 
...
//    
//    //****************************************
//    // Put every 16 Tacters into a string
//    //****************************************
//    
//    //cout << "\nstring array\n";
//    for (int i = 0; i<10; i++) {
