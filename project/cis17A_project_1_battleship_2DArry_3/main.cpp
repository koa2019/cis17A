...
struct Player{
    string name;
    char   **board;     // player's game board 
    //char   guess[];  // player's guesses
    float  hgScre;
    //char   guess[];
};
...
void cGssArr(const char [][COLS], const char [][COLS],const int,const int,int, int); // confirms guess[][] filled correctly             
void chckArr(char &);
void copyAdd(string [],const int,string[],const int,string);
void fileSum(int,int,int,int);
void fllGArr(char [][COLS],char [][COLS],char [], int, int, int &, int&);
...
void runMenu(string, char &, char &, int,int,int,int,char [][COLS],char [][COLS],
             char [][COLS],char [][COLS],int,int,int,int,int &,int&,string [],int,
             string [],int,vector<string> &);
void pause();
string pickP2(string [],int);  // randomly picks a number for player 2
void plyrShpBrd(int,int,const char [][COLS],const char [][COLS],const int,const int);
void print2DArr(const char [][COLS],const char [][COLS],
                const char [][COLS],const char [][COLS],const int,const int,int &,int &);
void prntArr(string []);  // prints names[]
void prntArr(const char [][COLS],int,int); //prints 2D
...
int main(int argc, char** argv) {
    ...
    // creating pointer to Player structure
...
//    }
    ...
    // show switch menu
//    runMenu(p2Names[0],ch,ans,count1,count2,numShp1,numShp2,guessP1,guessP2,board1,board2,
